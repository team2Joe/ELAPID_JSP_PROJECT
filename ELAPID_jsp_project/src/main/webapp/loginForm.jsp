	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
	      ...
	      <ul class="navbar-nav">
	        <li class="nav-item dropdown">
	          <a class="nav-link" href="questionList.do" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
	          	상품문의
	          </a>
	        </li>
	      </ul>
...
<div class="row" style="height: 700px">
	...
	<div class="col-lg-5">
		<form action="loginCheck.do" method="post">
			...
			<div class="mb-3 row" style="text-algin: center;">
				<label style="width: 40%; height: 40px; text-align: right"
					for="inputPassword" class="col-sm-2 col-form-label">아이디 : </label>
				<div class="col-sm-3">
			...
			<div class="col-sm-6"
				...
				<button style="width: 20%; height: 40px; text-align: center;"
					type="button" class="btn btn-dark"
					onclick="onSignIn()">google sign in </button>
					<br>
		...
		<form action="googleLogin.do" id="gform" method='post'>
			<input type="hidden" name="gname" id="gname" value="1">
			<input type="hidden" name="gemail" id="gemail" value="1">
			<input type="hidden" name="gimg" id="gimg" value="1">
		</form>
	</div>
</div>
