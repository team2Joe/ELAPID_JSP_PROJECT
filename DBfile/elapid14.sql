...
INSERT INTO `address` VALUES (1,'서울특별시 강남구 도곡동 972 도곡 한라비발디 아파트','6269'),(2,'부산광역시 부산진구 전포동 362-64 한라비발디','47306'),(3,'부산광역시 부산진구 범천동 1000-24 범내골역 한라비발디 STUDIO 422','47280'),(4,'',''),(5,'서울특별시 강남구 도곡동 972 도곡 한라비발디 아파트','06269'),(6,'서울특별시 서초구 서초동 1363-25 한라비발디 스튜디오193','06735'),(7,'경기도 용인시 기흥구 동백동 596 백현마을한라비발디아파트','17003'),(8,'경기도 의정부시 민락동 756-7 한라비발디아파트','11810'),(9,'경기도 하남시 감이동 530 감일 한라비발디','13004'),(10,'경기도 남양주시 별내동 808 별내별가람역 한라비발디','12097'),(11,'경기도 수원시 권선구 당수동 742 한라비발디아파트 2단지','16377'),(12,'서울특별시 강남구 논현동 188-3 아이파크','06118'),(13,'경기도 수원시 권선구 당수동 742 한라비발디아파트 2단지',''),(14,'경기도 남양주시 호평동 678 호평마을한라비발디 상가','12146'),(15,'서울특별시 중구 만리동2가 288 서울역한라비발디센트럴','04501');
...
INSERT INTO `cart` VALUES (6,'qwer123'),(1,'uyoung1'),(2,'uyoung2'),(3,'uyoung3'),(4,'uyoung4'),(5,'uyoung5');
...
INSERT INTO `cart_detail` VALUES (6719,15,1),(6720,1,1),(6721,1,6);
...
CREATE TABLE `login_log` (
  ...
  CONSTRAINT `fk_login_log_user1` FOREIGN KEY (`u_id`) REFERENCES `user` (`u_id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `login_log` VALUES (1,'2022-04-11 17:00:11','rlaxodjs11'),(2,'2022-04-11 19:49:22','rlaxodjs11'),(3,'2022-04-11 20:51:20','rlaxodjs11'),(4,'2022-04-11 20:51:50','rlaxodjs11'),(5,'2022-04-11 20:52:40','rlaxodjs11'),(6,'2022-04-11 21:47:38','rlaxodjs2'),(7,'2022-04-11 21:54:00','rlaxodjs11'),(8,'2022-04-12 12:18:00','rlaxodjs11'),(9,'2022-04-12 21:35:58','rlaxodjs11'),(10,'2022-04-12 21:48:06','rlaxodjs11'),(11,'2022-04-12 21:54:31','rlaxodjs11'),(12,'2022-04-13 10:35:03','rlaxodjs11'),(13,'2022-04-13 11:17:10','rlaxodjs11'),(14,'2022-04-13 11:18:59','qwer12'),(15,'2022-04-13 11:23:35','qwer123');
...
-- Dump completed on 2022-04-13 11:24:09
